...
export default function Header() {
  ...
  return (
    <Popover className="relative bg-white">
      <div className="fixed flex justify-between w-full px-4 py-6 bg-white shadow item s-center sm:px-6 md:justify-start md:space-x-10">
        <div>
            ...
            <Popover className="relative">
              {({ open }) => (
                ...
                >
                  ...
                  >
                    <Popover.Panel className="absolute z-10 w-screen max-w-md pt-3 -ml-4 transform lg:max-w-3xl">
